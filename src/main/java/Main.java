...
//
 //       hotels_weather_joined.printSchema();
        ...
        Dataset<Row> data_2016_with_watermark = data_2016.withWatermark("date_time", "2 hours");
        Dataset<Row> data_2017_with_watermark = data_2017.withWatermark("date_time", "2 hours");
